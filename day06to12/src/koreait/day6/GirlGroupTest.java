...
public class GirlGroupTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. 객체 생성한다");
		GirlGroup brave = new GirlGroup(); //객체를 생성: 객체는 클래스의 인스턴스(복사본)이다
		brave.year = 2011;
		...
		//nextInt()는 인스턴스 메소드 -> 객체 참조 변수.메소드명으로 실행
...
//		stacy.year = Integer.parseInt(sc.nextLine());//문자열을 정수로 바꿈
		
		System.out.print("멤버인원: ");
