...
public class TryCatchTest1 {
	...
	//실행중에 잘못된 값으로 발생하는 오류(Exception)를 처리한다.
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("null참조");
			
		}catch(Exception e) {	//Exception 이 발생한 오류 정보를 객체로 관리하고 참조변수는 e 이다
			System.out.println("잘못된 입력입니다.");
			//NullPointerException 제외하고 다른 Exception 발생시 처리되는 {}이다.
